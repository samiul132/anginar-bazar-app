...
import { getProductsByCategoryApi, handleApiError } from "../config/api";
            ...
            <View className="flex-row items-center">
              <View className="flex-1">
                <Text className="text-white text-2xl font-bold mb-1">
                  {categoryData.catInfo.category_name}
                </Text>
                <Text className="text-primary-100">
                  {categoryData.products?.total || 0} products available
                </Text>
              </View>
              <Image
                source={{ uri: getImageUrl(categoryData.catInfo.image) }}
